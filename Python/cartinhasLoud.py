...
def extract_champion_data(champion_info):
    ...
    match_games = re.search(r'(\d+)\s*$', champion_info, re.MULTILINE)
    if match_games:
        games = match_games.group(1).strip()
...
url = "https://gol.gg/teams/team-stats/2180/split-ALL/tournament-CBLOL%20Split%201%202024/"
headers = {
...
if response.status_code == 200:
    ...
    if table:
        ...
        plt.savefig('tabelaLoud.png', bbox_inches='tight', pad_inches=0.5)
        # plt.show()
